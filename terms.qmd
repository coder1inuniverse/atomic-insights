...
function searchGlossary() {
  var input, filter, dl, dt, i, txtValue;
  input = document.getElementById("searchInput");
  filter = input.value.toUpperCase();
  dl = document.getElementById("glossaryContent").getElementsByTagName("dl");
  for (i = 0; i < dl.length; i++) {
    dt = dl[i].getElementsByTagName("dt")[0];
...
document.getElementById("searchInput").addEventListener("keyup", searchGlossary);
</script>